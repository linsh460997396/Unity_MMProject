...
namespace CellSpace
{
    ...
    public class CellRingDiffuseXY
    {
        ...
        public List<CellXYInfo> idxys = new List<CellXYInfo>();
        ...
        public CellRingDiffuseXY(int gridNum, float cellSize)
        {
            ...
            //使用 key(由 ix 和 iy 组成的唯一标识符)来检查该点是否已经存在于 set 中.若不存在,则添加到 idxys 中,并且更新 set.
            //‌更新 lens‌:
            //若 idxys 的数量在当前半径迭代后有所增加,更新 lens 列表,添加新的 CellCountRadiusInfo 对象,记录当前点的数量和半径.
        }
    }
}
