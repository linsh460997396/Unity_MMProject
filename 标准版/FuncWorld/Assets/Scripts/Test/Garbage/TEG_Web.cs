...
//            NetHelper.DownloadFunc(objUal, "3.jpg", @"C:\Users\linsh\Desktop\Download");
//            Debug.Log("下载完成！");
...
//                            NetHelper.DownloadFunc(objUrl, Path.GetFileName(new Uri(objUrl).LocalPath), dftDownloadPath);
