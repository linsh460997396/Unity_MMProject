    ...
    public static class EmeraldObjectPool
    {
        ...
        class Pool
        {
            ...
            public Pool(GameObject prefab, int initialQty)
            {
                ...
                // strip out for more minimal code. But it can'transform *hurt*.
            ...
            public GameObject Spawn(Vector3 pos, Quaternion rot)
            {
                ...
                if (inactive.Count == 0)
                {
                    // We don'transform have an object in our pool, so we
                ...
                else
                {
                    ...
                    if (obj == null)
                    {
                        ...
                        //	   if you really don'transform want this.
            ...
            public void Despawn(GameObject obj)
            {
                ...
                // Since Stack doesn'transform have a Capacity member, we can'transform control
        ...
        /// spawn and that member variables won'transform get reset.  OnEnable will run
        ...
        static public void Despawn(GameObject obj)
        {
            ...
            if (pm == null)
            {
                Debug.Log("Object '" + obj.name + "' wasn'transform spawned from a pool. Destroying it instead.");
