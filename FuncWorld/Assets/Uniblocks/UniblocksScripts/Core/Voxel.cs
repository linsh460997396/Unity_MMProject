...
namespace Uniblocks
{
    ...
    public class Voxel : MonoBehaviour
    {
        ...
        /// <summary>
        /// 将体素设置为空块(id 0),更新块的网格并触发OnBlockDestroy事件.若启用多人模式,将体素更改发送给其他连接的玩家.
        /// </summary>
        /// <param name="voxelInfo"></param>
        ...
        /// <summary>
        /// 将体素设置为指定的id,更新块的网格并触发OnBlockPlace事件.若启用多人模式,将体素更改发送给其他连接的玩家.
        /// </summary>
        /// <param name="voxelInfo"></param>
        /// <param name="data"></param>
        /// <param name="sender"></param>
        ...
        /// <summary>
        /// 将体素设置为指定的id,更新块的网格并触发OnBlockChange事件.若启用多人模式,将体素更改发送给其他连接的玩家.
        /// </summary>
        /// <param name="voxelInfo"></param>
        /// <param name="data"></param>
        /// <param name="sender"></param>
