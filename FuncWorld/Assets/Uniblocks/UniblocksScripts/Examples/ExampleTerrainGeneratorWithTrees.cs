...
namespace Uniblocks
{
    ...
    public class ExampleTerrainGeneratorWithTrees : TerrainGenerator
    {
        ...
        public override void GenerateVoxelData()
        {
            ...
            //引擎设置:是否平地面
            Engine.KeepTerrainHeight = false;
            //设置恒定地形高度(世界坐标)
            ...
            for (int x = 0; x < SideLength; x++)
            {
                for (int y = 0; y < SideLength; y++)
                {
                    ...
                    { // for all voxels in the chunk
                        ...
                        Vector3 voxelPos = chunk.VoxelIndexToPosition(x, y, z); // get absolute position for the voxel.获取体素索引的世界绝对位置
        ...
        void AddTree(int x, int y, int z)
        {
            ...
            {
                chunk.SetVoxelSimple(x, y + trunkHeight, z, 6); // set wood at pixelY from 0 to 4
            }
