namespace MMWorld
{
    ...
    public class MMStage : Stage
    {
        ...
        public MMStage(Scene scene) : base(scene)
        ...
        {//关卡开局
         //配置怪生成器
            ...
            //创建怪物或NPC
            monsterGenerators.Add(new MMMonsterGenerator("MS2", this, time + Scene.fps * 10, time + Scene.fps * 20, 1));
        ...
        public void P3()
        {
            scene.SetStage(new MMStage(scene));          // 已超时:切到新关卡
        }
    }
}