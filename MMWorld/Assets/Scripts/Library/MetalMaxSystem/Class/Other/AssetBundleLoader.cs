...
namespace MetalMaxSystem.Unity
{
    ...
    public class AssetBundleLoader : MonoBehaviour
    {
        ...
        {
            //注意:如果Object是GameObject类型,则返回的Object实例可以直接转换为GameObject类型
        ...
        #region 这些代码是用来加载AB包的具体方法(如果协程调用失败,请用Instance方法创建组件实例来运行,协程必须依赖1个MonoBehaviour实例来运行)
        ...
        /// 如果同一函数特征的协程方法被执行多次(绑定多个协程实例)的话,无法精准操作每个实例个体的步进,会形成批量一起催促(慎用).
        /// </summary>
