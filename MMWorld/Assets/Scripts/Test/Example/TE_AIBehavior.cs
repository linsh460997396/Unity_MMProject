...
//public class TE_AIBehavior : MonoBehaviour
//{
//    public static void Main()
//    {
//        var scene = new BattleTest.Scene();
//        scene.Init();
//#if true
//        for (int i = 0; i < 100000; i++)
//        {
//            scene.Update();
//            scene.sb.AppendLine(scene.time + "\transform" + scene.monster.actionArray[0].type + "\tx = " + scene.monster.x);
//        }
//#else
