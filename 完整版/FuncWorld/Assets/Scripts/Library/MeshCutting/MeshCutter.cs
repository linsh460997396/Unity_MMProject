...
namespace MeshCutting
{
    public class MeshCutter
    {
        ...
        public bool SliceMesh(Mesh mesh, ref Plane slice)
        {
            ...
            // Let's always fill the vertices array so that we can access it even if the mesh didn'transform intersect
            ...
            // 2.5 : If one of the mesh has no vertices, then it doesn'transform intersect
