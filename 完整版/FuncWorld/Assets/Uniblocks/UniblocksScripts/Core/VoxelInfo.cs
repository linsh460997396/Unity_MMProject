namespace Uniblocks
{
    ...
    // voxel, which is used in the CellRaycast function - VoxelInfo.index
    ...
    public class VoxelInfo
    {
        ...
        /// <summary>
        /// 用体素索引(pixelX,pixelY,z)和团块对象'chunk'创建一个新的VoxelInfo.
        /// </summary>
        ...
        /// <summary>
        /// 用体素索引(pixelX,pixelY,z),相邻体素索引(pixelX,pixelY,z)和团块对象'chunk'创建一个新的VoxelInfo.
        /// </summary>
        /// <param name="setX"></param>
        /// <param name="setY"></param>
        /// <param name="setZ"></param>
        ...
        /// <summary>
        /// 更改存储在VoxelInfo中的体素数据,若updateMesh为true,则对标记团块的网格进行更新.当团块索引超过团块边界时将改变相应团块中的体素数据(如当前已实例化).
        /// </summary>
